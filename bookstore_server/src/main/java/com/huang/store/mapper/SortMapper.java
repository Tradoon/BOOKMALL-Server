...
public interface SortMapper {
    ...
    Long getBookSortId(String upperName,String sortName);//通过分类的一级分类名和二级分类名查找分类的id
    BookSort getBookSortById(Long id);//通过分类的id号查询id
    ...
    List<Long> getAllFirSortId(String sortName);//得到某一级分类的所有子类及其自己的id号集
    List<Long> getSecSortIdPage(String sortName,int page,int pageSize);//按页得到某一级分类的所有子类id号集
